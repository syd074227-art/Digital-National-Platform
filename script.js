...
// الرتب لكل وزارة – النسخة الأصلية
const jobOptions = {
  "وزارة الداخلية": ["جندي","جندي أول","عريف","وكيل رقيب","رقيب","رقيب أول","رئيس رقباء",
    "ملازم","ملازم أول","نقيب","رائد","مقدم","عقيد","عميد","لواء",
    "فريق","فريق أول","نائب مدير الأمن العام","مدير الأمن العام","نائب وزير الداخلية","وزير الداخلية","إدارة القبول والتجنيد"],
  "وزارة الصحة": ["مسعف","دكتور عام","دكتور","دكتور متمرس","طبيب عام","استشاري",
    ...
    "جراح","جراح مساعد","نائب وزير الصحة","وزير الصحة","مدير مستشفى","نائب مدير مستشفى","إدارة القبول والتسجيل"],
  "وزارة العدل": ["قاضي","قاضي متمرس","محامي","محامي متمرس","قاضي محكمة عليا",
...
// باقي السكربت كما كان – Face Detection والتحذيرات وحفظ البيانات
// يمكنك استخدام السكربت السابق للتحقق من الوجه، عرض الأخطاء، وحفظ البيانات
